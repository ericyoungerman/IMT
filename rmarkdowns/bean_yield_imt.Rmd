...
fig_eco_yield_total_model_kg <- ggplot(
  ...
  labs(
    ...
    title   = "Ecobean: bean yield by mowing treatment",
    caption = "Bars show LMM-predicted marginal means (kg ha\u207b\u00b9) \u00b1 SE."
  ) +
...
fig_eco_yield_total_model_lb <- ggplot(
  ...
  labs(
    ...
    title   = "Ecobean: bean yield by mowing treatment",
    caption = "Bars show LMM-predicted marginal means (lb ac\u207b\u00b9) \u00b1 SE."
  ) +
  theme_classic(base_size = 18) +
  theme(
    axis.text.x  = element_text(lineheight = 0.95, margin = margin(t = 8)),
