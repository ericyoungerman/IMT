...
weed_biomass_bi |>
  ...
  kable(
    digits  = 1,
    caption = "Weed biomass (kg ha⁻¹) by site-year × mowing treatment (ambient + surrogate weeds only)"
  ) |>
  kable_styling(
    full_width        = FALSE,
...
weed_biomass_bi |>
  ...
  labs(
    ...
    title = "Weed biomass by mowing treatment across site-years (ambient + surrogate weeds)"
  ) +
  theme(
